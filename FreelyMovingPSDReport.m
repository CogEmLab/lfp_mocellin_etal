function [rplot]=FreelyMovingPSDReport(data_ds,t_ds,adc_ds,t_adc_ds,scale,channels)
...
threshold=0.2; 
baseline=2; %which type of normalization (0/1/2)?
...
mean_F=mean(P_adc(F_adc>15.5 & F_adc<16.5,:),1);
